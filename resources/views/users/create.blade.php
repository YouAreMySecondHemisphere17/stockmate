<x-layouts.app>
    ...
    <div class="container-lightgray card p-6 shadow-lg rounded-lg bg-white border border-gray-200 form-custom">
        <h2 class="text-2xl font-semibold mb-6 text-gray-800">Registrar Nuevo Usuario</h2>
        ...
        <form action="{{route('users.store')}}" method="POST" class="space-y-6">
            ...
            <div class="flex">
                <div class="flex-2 mr-3">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Escribe el nombre del usuario." class="w-full border-gray-300 rounded-md">
               </div>  
            </div>  
