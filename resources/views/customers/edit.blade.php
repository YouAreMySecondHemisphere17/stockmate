        ...
        <form action="{{ route('customers.update', $customer) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex">
                <div class="flex-5 mr-3">
                    ...
                    <input type="text" name="customer_name" value="{{ old('customer_name', $customer->customer_name) }}" placeholder="Escribe el nombre del cliente." class="w-full border-gray-300 rounded-md">
               </div>  
