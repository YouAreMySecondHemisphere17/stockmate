            ...
            <div class="flex">
               ...
               <div class="flex-2 mr-3">
                ...
                <div class="flex-1 mr-3">
                    ...
                    <input type="number" id="sold_price" name="sold_price" value="{{ old('sold_price', "1.99") }}" class="w-full price-input border-gray-300 rounded-md" step="0.01" min="0.01" max="999999.99">
                </div> 
